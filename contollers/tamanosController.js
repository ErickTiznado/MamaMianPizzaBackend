...
exports.GetSizesandPrices = (req, res) => {
    pool.query('SELECT tamanos.id_tamano, tamanos.nombre, tamanos.indice, precios.precio FROM tamanos JOIN precios ON tamanos.id_tamano = precios.tamano_id', (err, results) => {
        if (err) {
