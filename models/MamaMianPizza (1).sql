...
-- Tiempo de generación: 15-06-2025 a las 04:36:23
...
(3, 3, 1, 'Pizza de peperoni', 4, 12.00, 'Tradicional', 'gigante', NULL, 0, 48.00),
(4, 4, 3, 'Cheese Sticks con Salsa1', 4, 12.00, 'Tradicional', 'gigante', NULL, 0, 48.00),
(5, 4, 1, 'Pizza de peperoni', 1, 8.00, 'Tradicional', 'grande', NULL, 0, 8.00),
(6, 4, 1, 'Pizza de peperoni', 1, 10.00, 'Tradicional', 'grande', 'Ingredientes extra: Jamo, Curiles', 0, 10.00),
(7, 5, 3, 'Cheese Sticks con Salsa1', 1, 6.00, 'Delgada', 'Personal', NULL, 1, 6.00),
(8, 6, 1, 'Pizza de peperoni', 1, 4.00, 'Tradicional', 'Personal', NULL, 0, 4.00),
(9, 7, 1, 'Pizza de peperoni', 1, 4.00, 'Tradicional', 'Personal', NULL, 0, 4.00),
...
(13, 'JSEEVCSE', 4, 13, '2025-06-14 20:21:23', 'pendiente', 13.56, 'registrado', 'efectivo', 'milena zelaya', NULL, '70141812', 'nathy.zelaya55@gmail.com', NULL, NULL, 12.00, 0.00, 1.56, 1, 25, NULL, NULL, NULL);
...
(1, 'Pizza de peperoni', 'sadsad', 'Las mas Populares', 1, 0, 'https://server.tiznadodev.com/uploads/imagen-1749613230378-900169573.jpg', '2025-06-11 03:08:13', '2025-06-11 03:42:46'),
(2, 'Pizza de peperoni', 'sdfsdf', 'Las mas Populares', 1, 0, 'https://api.mamamianpizza.com/uploads/imagen-1749613690433-312357071.jpg', '2025-06-11 03:47:04', '2025-06-11 03:51:27'),
...
(1, 4, 3, 'fghfghfhfghfg', 5, '2025-06-14 22:52:29', 0);
...
(3, 'nathaly milena', 'nathy.zelaya5@gmail.com', '$2b$10$UkKD/yDKIIcaqN3Hl.K1KuBWENdiB.f4u9eDK7dnV9uxcwCWVxS/2', '70141812', '2007-06-03', 'F', '123456789', NULL),
(4, 'milena zelaya', 'nathy.zelaya55@gmail.com', '$2b$10$0Wx.0HLRSnbl6amYtIy1R.MDh/55Hks0LoZBVgg4.rW8yRXYj2Gd6', '70141812', '1992-06-04', 'F', '123456789', NULL),
...
(1, 'ERICK', 'TIZNADO', '70830446', '2025-06-12 01:43:46', '2025-06-14 19:24:32'),
...
--
ALTER TABLE `notificaciones`
  MODIFY `id_notificacion` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `pedidos`
  MODIFY `id_pedido` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `resenas`
  MODIFY `id_resena` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
